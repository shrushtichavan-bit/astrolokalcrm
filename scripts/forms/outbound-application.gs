/**
 * Google Apps Script — bound to the Google Form
 * "AstroLokal Astrologer Application Form (Outbound)".
 *
...
var FORM_NAME = "AstroLokal Astrologer Application Form (Outbound)";
var SOURCE = "OutBound Leads";
...
function testWithDummySubmission() {
  ...
  raw["Phone Number"] = "9999999999";
  raw["City you are currently based in"] = "Mumbai";
